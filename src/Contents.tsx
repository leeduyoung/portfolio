                    ...
                    <div className="inner">
                        ...
                        <p className="description03">
                            ...
                            <p className="simple-career">
                                ...
                                <span>지텐션</span> / 백엔드 개발, 백오피스 개발 / 2020.01 ~ 현재 재직중
                                <br />
                    ...
                    <div className="inner">
                        ...
                        <div className="work-list clear">
                            ...
                            <div className="right">
                                        ...
                                        <img src="assets/img/golf.jpg" className="work_image" />
                                            <figcaption className="work_caption">
                                                <div className="caption-text"> 
                                                    ...
                                                    <p className="caption-desc">필요한 만큼 결제하고 필요한 곳을 합리적으로 이 용하는 골프 O2O 서비스</p>
                                                </div>
                                        ...
                                        <img src="assets/img/yoga.jpg" className="work_image" />
                                            <figcaption className="work_caption">
                                                <div className="caption-text"> 
                                                    ...
                                                    <p className="caption-desc">기업 임직원을 대상으로 다양한 스포츠센터와 골 프시설들을 하나의 멤버십 으로 언제 어디서나 저 렴하게 이용할 수 있도록 도와주는 피트니스 O2O 서비스</p>
                                                </div>
                                ...
                                <div className="work-item">
                                    <figure>
                                        <img src="assets/img/insurance.jpg" className="work_image" />
                                            <figcaption className="work_caption">
                                                <div className="caption-text"> 
                                                    <strong className="caption-title">보험닥터</strong> 
                                                    <p className="caption-desc">인공지능설계사 보험닥터 하이브리드 앱</p>
                                                </div>
                                                <a href="https://www.myrealplan.co.kr" target="_blank"></a>
                                            </figcaption>
                                    </figure>
                                </div>
                            </div>
